...
//! Shared helpers for synthetic BLS sigverify fixture generation and replay.
...
fn convert_legacy_workload(legacy: StoredWorkloadV1) -> StoredWorkload {
    let per_slot_packets = legacy.votes_per_slot.saturating_add(legacy.certs_per_slot);
